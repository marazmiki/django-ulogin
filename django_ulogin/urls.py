...
urlpatterns = [
    url('^identities/$', IdentityListView.as_view(), name='ulogin_identities_list'),
    url('^identities/(?P<pk>\d+)/delete/$', IdentityDeleteView.as_view(), name='ulogin_identities_delete'),
